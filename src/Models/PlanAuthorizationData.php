...
class PlanAuthorizationData implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @required
     * @maps Status
     * @factory \SplititWebApiV4Lib\Models\AuthorizationStatusEnum::checkValue
     */
     ...
     */
    public function getThreeDSRedirect(): ?ThreeDSRedirectData
    {
     ...
     */
    public function setThreeDSRedirect(?ThreeDSRedirectData $threeDSRedirect): void
    {
    ...
    /**
     * Converts the PlanAuthorizationData object to a human-readable string representation.
     *
     * @return string The string representation of the PlanAuthorizationData object.
     */
