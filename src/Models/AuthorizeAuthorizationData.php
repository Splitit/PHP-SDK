...
class AuthorizeAuthorizationData implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the AuthorizeAuthorizationData object to a human-readable string representation.
     *
     * @return string The string representation of the AuthorizeAuthorizationData object.
     */
