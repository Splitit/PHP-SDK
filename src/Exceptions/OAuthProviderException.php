...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \SplititWebApiV4Lib\Http\HttpRequest $request
     * @param \SplititWebApiV4Lib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \SplititWebApiV4Lib\Http\HttpRequest $request,
        \SplititWebApiV4Lib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \SplititWebApiV4Lib\Models\OAuthProviderErrorEnum::checkValue
     */
