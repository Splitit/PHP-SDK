...
use SplititWebApiV4Lib\Models\OAuthToken;
...
class OAuth2CredentialsBuilder
{
     ...
     * instance, while Arg2 will be an instance of OAuth2Manager. The return type of callable should be an
     * instance of OAuthToken model.
     *
     * @param callable(OAuthToken, OAuth2Manager): OAuthToken $oAuthTokenProvider
     *
     * @return $this
     */
